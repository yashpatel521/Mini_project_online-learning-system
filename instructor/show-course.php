...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/v/bs4-4.1.1/jq-3.3.1/dt-1.10.21/datatables.min.css" />
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4-4.1.1/jq-3.3.1/dt-1.10.21/datatables.min.js">
    </script>
</head>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Show-course</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                if ($query->rowCount() > 0) {
                                    ...
                                    <div class='card-body'>
                                        <div class='d-flex align-items-center mb-4'>
                                            <h4 class='card-title text-capitalize'>Courses Upload By $instructorLoggedName</h4>
                                        </div>
                                                    ...
                                                    <table class='table  no-wrap v-middle mb-0'>
                                                        <thead class=' text-white' style='background-color: rgba(95, 118, 232, 1);'>
                                                            <tr class='border-0'>
                                                                ...
                                                                <th class='border-0 font-14 font-weight-medium text-center'>Rating</th>
                                                                <th class='border-0 font-14 font-weight-medium text-center'>Details</th>
                                                        ...
                                                        while($row = $query->fetch(PDO::FETCH_ASSOC)) {
                                                            ...
                                                            $ct_name = $ct_row["name"];
                                                            $c++;
                                                            $r_query = $con->prepare("SELECT TRUNCATE(AVG(course_rate),1) as c_avg FROM feedback WHERE course_id = $id ");
                                                            $r_query->execute();
                                                            ...
                                                            // <td class='text-dark text-center  '>".$row['duration']."</td>
                                                            // <td class='text-dark text-center '>".$row['language']."</td>
                                                        echo "<tr>
                                                                <td>$c</td>
                                                                <td class='text-dark text-center'>".$row["name"]."</td>
                                                                <td class='text-center text-dark  '>$ct_name</td>
                                                                <td class='text-center text-dark  '>$rating</td>
                                                                <td class='text-center'>
                                                                <a href='show-course-details.php?entities=$row[id]' style='margin-bottom:5px;' class='btn btn-primary'><i class='fas fa-eye'></i></a>
                                                                </td>
                                                                <td class='text-center'>
                                    ...
                                    echo "<div class='card  align-items-center'>
                                            <div class='card-body'>
                                                ...
                                                <h4 class='text-capitalize text-center'>No Courses Found </h4>
                                                    <a href='create-course.php'  class='btn btn-success align-items-center mx-4 text-center'><i class='fas fa-edit'>Create Course</i></a>
                                                </div>
                                            </div>
                                        </div>";
                                }
